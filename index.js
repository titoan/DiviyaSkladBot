...
Последние изменения на складе: ${tableInfo.getLastChangeDate(tableInfo.jsonSheet_Instruments)}
...
Последние изменения на складе: ${tableInfo.getLastChangeDate(tableInfo.jsonSheet_chainTubes)}
...
Последние изменения на складе: ${tableInfo.getLastChangeDate(tableInfo.jsonSheet_Tubes)}
